  ...
  return (
    <div className="min-h-screen bg-beige-light overflow-x-hidden">
      ...
      <main>
        ...
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white via-orange-50 to-beige-light relative overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-[400px] sm:w-[500px] md:w-[600px] h-[400px] sm:h-[500px] md:h-[600px] rounded-full bg-yellow-100/30 absolute -top-20 -left-20 animate-pulse"></div>
            <div className="w-[300px] sm:w-[400px] md:w-[500px] h-[300px] sm:h-[400px] md:h-[500px] rounded-full bg-orange-100/30 absolute bottom-20 right-20 animate-pulse delay-300"></div>
          </div>
          <div className="w-full px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <div className="flex justify-center mb-6 sm:mb-8">
                <div className="bg-yellow-100/50 p-4 rounded-full">
                  <Sparkles className="w-8 h-8 sm:w-10 sm:h-10 text-orange-500" />
                </div>
              </div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-display font-bold text-brown mb-6 sm:mb-8">
                About Us
              </h1>
              <div className="w-32 sm:w-40 md:w-48 h-1 bg-gradient-to-r from-yellow-200 via-orange-300 to-yellow-200 mx-auto mb-8 sm:mb-12"></div>
        ...
        <section className="py-16 sm:py-20 md:py-24 flex items-center justify-center bg-white relative">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-[300px] sm:w-[400px] md:w-[500px] h-[300px] sm:h-[400px] md:h-[500px] rounded-full bg-yellow-100/20 absolute top-20 left-20 animate-pulse"></div>
            <div className="w-[200px] sm:w-[300px] md:w-[400px] h-[200px] sm:h-[300px] md:h-[400px] rounded-full bg-orange-100/20 absolute bottom-20 right-20 animate-pulse delay-300"></div>
          </div>
          <div className="w-full px-4 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-12 h-12 bg-yellow-100/50 rounded-full flex items-center justify-center">
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-orange-50 relative">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] rounded-full bg-yellow-100/20 absolute top-20 left-20 animate-pulse"></div>
            <div className="w-[200px] sm:w-[300px] h-[200px] sm:h-[300px] rounded-full bg-orange-100/20 absolute bottom-20 right-20 animate-pulse delay-300"></div>
          </div>
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-yellow-100">
        ...
        <section className="py-16 sm:py-20 md:py-24 flex items-center justify-center bg-gradient-to-b from-white to-orange-50 relative">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-[400px] sm:w-[500px] h-[400px] sm:h-[500px] rounded-full bg-yellow-100/20 absolute top-20 left-20 animate-pulse"></div>
            <div className="w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] rounded-full bg-orange-100/20 absolute bottom-20 right-20 animate-pulse delay-300"></div>
          </div>
          <div className="w-full px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <div className="flex justify-center mb-6">
